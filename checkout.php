  ...
  <![endif]-->
	...
	<div class="checkout-area mt-95 sm-mt-75">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p>Returning customer? <a href="login.php">Click here</a> to login</p>
				</div>
			</div>
			<div class="row mt-10">
				<div class="col-lg-8">
					<div class="billing-form">
						...
						<form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="place-order text-center btn-block">
                                <button type="submit" name="send" class="btn-common width-180">place porder</button>
                            </div>
...
if (isset($_POST['send'])){
    ...
    $q="INSERT INTO `users` (`names`, `email`, `phone`, `password`) VALUES ('$names', '$email', '$phone', '$password')";
